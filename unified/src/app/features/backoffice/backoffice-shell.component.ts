      ...
      <div class="navbar-content">
        <ul class="nxl-navbar">
          ...
          <li class="nxl-item nxl-hasmenu" [class.nxl-trigger]="clientsExpanded">
            <a href="javascript:void(0)" class="nxl-link" (click)="clientsExpanded = !clientsExpanded">
          ...
          <li class="nxl-item">
            <a routerLink="/backoffice/orders" routerLinkActive="active" class="nxl-link">
              <span class="nxl-micon">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <li class="nxl-item">
            <a routerLink="/backoffice/my-events" routerLinkActive="active" class="nxl-link">
              <span class="nxl-micon">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <li class="nxl-item nxl-hasmenu" [class.nxl-trigger]="configExpanded" *ngIf="hasRoleSuper">
            <a href="javascript:void(0)" class="nxl-link" (click)="configExpanded = !configExpanded">
              <span class="nxl-micon">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
