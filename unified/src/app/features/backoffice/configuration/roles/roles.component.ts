...
@Component({
            ...
            <table class="table table-hover mb-0">
              <thead>
                <tr>
                  ...
                  <th>Description</th>
                  <th class="text-end">
                    <button class="btn-icon-action btn-icon-add" (click)="openRoleModal()" title="Add Role">
                  ...
                  @for (role of roles; track role.id) {
                    <tr>
                      ...
                      <td class="text-end">
                        ...
                        <button class="btn-icon-action btn-icon-action-sm btn-icon-delete" (click)="confirmDelete(role)" title="Delete Role">
                          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      <div class="modal-overlay" (click)="closeModal()">
        <div class="modal" (click)="$event.stopPropagation()">
          ...
          <div class="modal-footer">
            ...
            <button class="btn btn-primary" (click)="saveRole()" [disabled]="saving || !formData.name.trim()">
  ...
  styles: [`
    ...
    .table thead th { padding: 12px 20px; font-size: 12px; font-weight: 600; text-transform: uppercase; color: var(--text-muted); background: var(--bg-light); border-bottom: 1px solid var(--border-color); }
