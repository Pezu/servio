...
public class OrderEntity {
    ...
    // Fiscal-receipt tracking moved to its own table (fiscal_receipts), one row
    // per dispatch — see FiscalReceiptEntity. Partial payments produce several
    // receipts per order, which a single order-level status couldn't represent.
